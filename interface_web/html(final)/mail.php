...
<html lang="fr">
  ...
  <div class="content">
    ...
    <p>Veuillez remplir ce formulaire pour ainsi générer et envoyer par mail le QR Code au personnel.</p>
...
<a href="../accueil/accueil.php"><h2>Accueil</h2></a>
  ...
  <a href="mail.php">Envoi QR Code par mail</a>
...
<?php
	...
	//on inclus la librairie 'phpqrcode' pour générer un qr code et l'enregistrer dans un fichier tmp sur la rasp
    ...
    $sql = "SELECT adresse_mail,QR FROM Personnel WHERE nom = '$nom' AND prenom = '$prenom'";
...
QRcode::png($data2, $pngAbsoluteFilePath); //création du qr code en fichier png
...
$path = "../tmp/QRCode_$nom"."_"."$prenom.png";
...
if(file_exists($path)){
  ...
  echo '<script>alert("ERREUR le mail n\'as pas pu être envoyé")</script>';
}
}
?>
</body>
