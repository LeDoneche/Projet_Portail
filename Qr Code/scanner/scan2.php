        ...
        <div class="container">
                ...
                <div class="un">
                    ...
                    <?php include 'img.php'?>
                     ...
                     <img  src="http://172.20.233.38/command/inquiry.cgi?ind=camera" id="cam" width="10%" height="10%" controls autoplay></img> 

                   <!--  <iframe name="frame" src="http://172.20.233.38/oneshotimage1?1646380138519" id="cam" width="100%" height="100%"></iframe>-->
